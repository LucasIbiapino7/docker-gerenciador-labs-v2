...
// FORÇA usar localhost via NGINX sempre
const CORRECTED_AUTH_URL = "http://localhost";

export const oidcConfig = {
  // >>> MUDANÇA CRÍTICA: usa localhost via NGINX
  authority: CORRECTED_AUTH_URL,
  ...
  // >>> FORÇA buscar o discovery via NGINX
...
export function AuthProvider({ children }) {
  ...
  // Carrega usuário inicial e escuta eventos
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const extracted = Array.isArray(payload?.authorities)
      ? payload.authorities
